...
CREATE TABLE IF NOT EXISTS `size` (
  `id` smallint(6) DEFAULT NULL,
  `unit` tinytext,
  `sizeCol01` smallint(6) DEFAULT NULL,
  `sizeCol02` smallint(6) DEFAULT NULL,
  `sizeCol03` smallint(6) DEFAULT NULL,
  `sizeCol04` smallint(6) DEFAULT NULL,
  `sizeCol05` smallint(6) DEFAULT NULL,
  `sizeCol06` smallint(6) DEFAULT NULL,
  `sizeCol07` smallint(6) DEFAULT NULL,
  `sizeCol08` smallint(6) DEFAULT NULL,
  `sizeCol09` smallint(6) DEFAULT NULL,
